...
from materials.views import CourseViewSet, LessonCreateApiView, LessonListApiView, LessonRetrieveApiView, LessonUpdateApiView, LessonDestroyeApiView
...
urlpatterns = [
    ...
    path("lesson/<int:pk>/delete/", LessonDestroyeApiView.as_view(), name="LessonDestroy"),
